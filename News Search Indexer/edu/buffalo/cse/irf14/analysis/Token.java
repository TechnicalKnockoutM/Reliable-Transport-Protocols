...
//	private ArrayList<String> termAL;
	
	public Token(String tokStr) {
		// TODO Auto-generated constructor stub
		//tokenString = tokStr;
		setTermText(tokStr);//Modified by Susana
//		termAL.add(getTermText());//Added by Susana
	}
...
//			
		...
		else
		{
			...
			{
				termText = termText + " " + tok.toString();
			}
		}
